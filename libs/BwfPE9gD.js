import{_ as e,g as t,a as n,r as i,b as s,S as r}from"./Df0tmYcv.js";import{a as o}from"./C8FxGguD.js";import{a,D as l,c as h,e as c,s as u,f as d,d as _,h as p,j as f,p as m,u as g,k as y,l as v,m as C,n as w,o as T,S as I,q as k,r as b,t as E,w as S,x as N,y as P,z as x,A as R,B as D,C as M,G as F,H as q}from"./CxZUDWMV.js";import{L as A,a as L}from"./BPKdAadz.js";var O={};const W="@firebase/database",U="1.0.19";
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ue{constructor(e){this.allowedEvents_=e,this.listeners_={},d(Array.isArray(e)&&e.length>0,"Requires a non-empty array")}trigger(e,...t){if(Array.isArray(this.listeners_[e])){const n=[...this.listeners_[e]];for(let e=0;e<n.length;e++)n[e].callback.apply(n[e].context,t)}}on(e,t,n){this.validateEventType_(e),this.listeners_[e]=this.listeners_[e]||[],this.listeners_[e].push({callback:t,context:n});const i=this.getInitialEvent(e);i&&t.apply(n,i)}off(e,t,n){this.validateEventType_(e);const i=this.listeners_[e]||[];for(let s=0;s<i.length;s++)if(i[s].callback===t&&(!n||n===i[s].context))return void i.splice(s,1)}validateEventType_(e){d(this.allowedEvents_.find((t=>t===e)),"Unknown event: "+e)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class je extends Ue{static getInstance(){return new je}constructor(){super(["online"]),this.online_=!0,"undefined"==typeof window||void 0===window.addEventListener||R()||(window.addEventListener("online",(()=>{this.online_||(this.online_=!0,this.trigger("online",!0))}),!1),window.addEventListener("offline",(()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))}),!1))}getInitialEvent(e){return d("online"===e,"Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let gt;pt.EMPTY_NODE=new class{copy(e,t,n,i,s){return this}insert(e,t,n){return new _t(e,t,null)}remove(e,t){return this}count(){return 0}isEmpty(){return!0}inorderTraversal(e){return!1}reverseTraversal(e){return!1}minKey(){return null}maxKey(){return null}check_(){return 0}isRed_(){return!1}};const yt=function(e){return"number"==typeof e?"number:"+_e(e):"string:"+e},vt=function(e){if(e.isLeafNode()){const t=e.val();d("string"==typeof t||"number"==typeof t||"object"==typeof t&&v(t,".sv"),"Priority must be a string or number.")}else d(e===gt||e.isEmpty(),"priority of unexpected type.");d(e===gt||e.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Nt;const Pt={};class xt{static get Default(){return d(Pt&&kt,"ChildrenNode.ts has not been loaded"),Nt=Nt||new xt({".priority":Pt},{".priority":kt}),Nt}constructor(e,t){this.indexes_=e,this.indexSet_=t}get(e){const t=y(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof pt?t:null}hasIndex(e){return v(this.indexSet_,e.toString())}addIndex(e,t){d(e!==ut,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const n=[];let i=!1;const s=t.getIterator(at.Wrap);let r,o=s.getNext();for(;o;)i=i||e.isDefinedOn(o.node),n.push(o),o=s.getNext();r=i?St(n,e.getCompare()):Pt;const a=e.toString(),l=Object.assign({},this.indexSet_);l[a]=e;const h=Object.assign({},this.indexes_);return h[a]=r,new xt(h,l)}addToIndexes(e,t){const n=C(this.indexes_,((n,i)=>{const s=y(this.indexSet_,i);if(d(s,"Missing index implementation for "+i),n===Pt){if(s.isDefinedOn(e.node)){const n=[],i=t.getIterator(at.Wrap);let r=i.getNext();for(;r;)r.name!==e.name&&n.push(r),r=i.getNext();return n.push(e),St(n,s.getCompare())}return Pt}{const i=t.get(e.name);let s=n;return i&&(s=s.remove(new at(e.name,i))),s.insert(e,e.node)}}));return new xt(n,this.indexSet_)}removeFromIndexes(e,t){const n=C(this.indexes_,(n=>{if(n===Pt)return n;{const i=t.get(e.name);return i?n.remove(new at(e.name,i)):n}}));return new xt(n,this.indexSet_)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class jt{constructor(e){this.index_=e}updateChild(e,t,n,i,s,r){d(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const o=e.getImmediateChild(t);return o.getChild(i).equals(n.getChild(i))&&o.isEmpty()===n.isEmpty()?e:(null!=r&&(n.isEmpty()?e.hasChild(t)?r.trackChildChange(Wt(t,o)):d(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):o.isEmpty()?r.trackChildChange(Ot(t,n)):r.trackChildChange(Ut(t,n,o))),e.isLeafNode()&&n.isEmpty()?e:e.updateImmediateChild(t,n).withIndex(this.index_))}updateFullNode(e,t,n){return null!=n&&(e.isLeafNode()||e.forEachChild(kt,((e,i)=>{t.hasChild(e)||n.trackChildChange(Wt(e,i))})),t.isLeafNode()||t.forEachChild(kt,((t,i)=>{if(e.hasChild(t)){const s=e.getImmediateChild(t);s.equals(i)||n.trackChildChange(Ut(t,i,s))}else n.trackChildChange(Ot(t,i))}))),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?Dt.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yt{constructor(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=kt}hasStart(){return this.startSet_}isViewFromLeft(){return""===this.viewFrom_?this.startSet_:"l"===this.viewFrom_}getIndexStartValue(){return d(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}getIndexStartName(){return d(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:re}hasEnd(){return this.endSet_}getIndexEndValue(){return d(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}getIndexEndName(){return d(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:oe}hasLimit(){return this.limitSet_}hasAnchoredLimit(){return this.limitSet_&&""!==this.viewFrom_}getLimit(){return d(this.limitSet_,"Only valid if limit has been set"),this.limit_}getIndex(){return this.index_}loadsAllData(){return!(this.startSet_||this.endSet_||this.limitSet_)}isDefault(){return this.loadsAllData()&&this.index_===kt}copy(){const e=new Yt;return e.limitSet_=this.limitSet_,e.limit_=this.limit_,e.startSet_=this.startSet_,e.startAfterSet_=this.startAfterSet_,e.indexStartValue_=this.indexStartValue_,e.startNameSet_=this.startNameSet_,e.indexStartName_=this.indexStartName_,e.endSet_=this.endSet_,e.endBeforeSet_=this.endBeforeSet_,e.indexEndValue_=this.indexEndValue_,e.endNameSet_=this.endNameSet_,e.indexEndName_=this.indexEndName_,e.index_=this.index_,e.viewFrom_=this.viewFrom_,e}}function Vt(e){const t={};if(e.isDefault())return t;let n;if(e.index_===kt?n="$priority":e.index_===At?n="$value":e.index_===ut?n="$key":(d(e.index_ instanceof qt,"Unrecognized index type!"),n=e.index_.toString()),t.orderBy=w(n),e.startSet_){const n=e.startAfterSet_?"startAfter":"startAt";t[n]=w(e.indexStartValue_),e.startNameSet_&&(t[n]+=","+w(e.indexStartName_))}if(e.endSet_){const n=e.endBeforeSet_?"endBefore":"endAt";t[n]=w(e.indexEndValue_),e.endNameSet_&&(t[n]+=","+w(e.indexEndName_))}return e.limitSet_&&(e.isViewFromLeft()?t.limitToFirst=e.limit_:t.limitToLast=e.limit_),t}function Bt(e){const t={};if(e.startSet_&&(t.sp=e.indexStartValue_,e.startNameSet_&&(t.sn=e.indexStartName_),t.sin=!e.startAfterSet_),e.endSet_&&(t.ep=e.indexEndValue_,e.endNameSet_&&(t.en=e.indexEndName_),t.ein=!e.endBeforeSet_),e.limitSet_){t.l=e.limit_;let n=e.viewFrom_;""===n&&(n=e.isViewFromLeft()?"l":"r"),t.vf=n}return e.index_!==kt&&(t.i=e.index_.toString()),t}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(tn=en||(en={}))[tn.OVERWRITE=0]="OVERWRITE",tn[tn.MERGE=1]="MERGE",tn[tn.ACK_USER_WRITE=2]="ACK_USER_WRITE",tn[tn.LISTEN_COMPLETE=3]="LISTEN_COMPLETE";class sn{constructor(e,t,n){this.path=e,this.affectedTree=t,this.revert=n,this.type=en.ACK_USER_WRITE,this.source={fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}operationForChild(e){if(Je(this.path)){if(null!=this.affectedTree.value)return d(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new He(e));return new sn(ze(),t,this.revert)}}return d(Ye(this.path)===e,"operationForChild called for unrelated child."),new sn(Be(this.path),this.affectedTree,this.revert)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class an{constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=en.MERGE}operationForChild(e){if(Je(this.path)){const t=this.children.subtree(new He(e));return t.isEmpty()?null:t.value?new on(this.source,ze(),t.value):new an(this.source,ze(),t)}return d(Ye(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new an(this.source,Be(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zn{constructor(){this.changeMap=new Map}trackChildChange(e){const t=e.type,n=e.childName;d("child_added"===t||"child_changed"===t||"child_removed"===t,"Only child changes supported for tracking"),d(".priority"!==n,"Only non-priority child changes can be tracked.");const i=this.changeMap.get(n);if(i){const s=i.type;if("child_added"===t&&"child_removed"===s)this.changeMap.set(n,Ut(n,e.snapshotNode,i.snapshotNode));else if("child_removed"===t&&"child_added"===s)this.changeMap.delete(n);else if("child_removed"===t&&"child_changed"===s)this.changeMap.set(n,Wt(n,i.oldSnap));else if("child_changed"===t&&"child_added"===s)this.changeMap.set(n,Ot(n,e.snapshotNode));else{if("child_changed"!==t||"child_changed"!==s)throw b("Illegal combination of changes: "+e+" occurred after "+i);this.changeMap.set(n,Ut(n,e.snapshotNode,i.oldSnap))}}else this.changeMap.set(n,e)}getChanges(){return Array.from(this.changeMap.values())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bn(e,t,n,i,s){const r=new zn;let o,a;if(n.type===en.OVERWRITE){const l=n;l.source.fromUser?o=Qn(e,t,l.path,l.snap,i,s,r):(d(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered()&&!Je(l.path),o=Gn(e,t,l.path,l.snap,i,s,a,r))}else if(n.type===en.MERGE){const l=n;l.source.fromUser?o=function(e,t,n,i,s,r,o){let a=t;return i.foreach(((i,l)=>{const h=$e(n,i);$n(t,Ye(h))&&(a=Qn(e,a,h,l,s,r,o))})),i.foreach(((i,l)=>{const h=$e(n,i);$n(t,Ye(h))||(a=Qn(e,a,h,l,s,r,o))})),a}(e,t,l.path,l.children,i,s,r):(d(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered(),o=Xn(e,t,l.path,l.children,i,s,a,r))}else if(n.type===en.ACK_USER_WRITE){const a=n;o=a.revert?function(e,t,n,i,s,r){let o;if(null!=On(i,n))return t;{const a=new Vn(i,t,s),l=t.eventCache.getNode();let h;if(Je(n)||".priority"===Ye(n)){let n;if(t.serverCache.isFullyInitialized())n=qn(i,fn(t));else{const e=t.serverCache.getNode();d(e instanceof Dt,"serverChildren would be complete if leaf node"),n=An(i,e)}h=e.filter.updateFullNode(l,n,r)}else{const s=Ye(n);let c=Un(i,s,t.serverCache);null==c&&t.serverCache.isCompleteForChild(s)&&(c=l.getImmediateChild(s)),h=null!=c?e.filter.updateChild(l,s,c,Be(n),a,r):t.eventCache.getNode().hasChild(s)?e.filter.updateChild(l,s,Dt.EMPTY_NODE,Be(n),a,r):l,h.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=qn(i,fn(t)),o.isLeafNode()&&(h=e.filter.updateFullNode(h,o,r)))}return o=t.serverCache.isFullyInitialized()||null!=On(i,ze()),dn(t,h,o,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
