import{C as e,a as t}from"./C8FxGguD.js";import{L as a}from"./BPKdAadz.js";import{g as r,E as i,d as s,b as n,i as o,v as c,F as h}from"./CxZUDWMV.js";import{o as p}from"./CFK1l90-.js";
/**
 * @license
 ...
 */class l{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map((e=>{if(function(e){const t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null})).filter((e=>e)).join(" ")}}const f="@firebase/app",d="0.13.1",b=new a("@firebase/app"),m="@firebase/app-compat",g="@firebase/analytics-compat",u="@firebase/analytics",w="@firebase/app-check-compat",v="@firebase/app-check",_="@firebase/auth",C="@firebase/auth-compat",D="@firebase/database",y="@firebase/data-connect",E="@firebase/database-compat",S="@firebase/functions",I="@firebase/functions-compat",$="@firebase/installations",j="@firebase/installations-compat",P="@firebase/messaging",k="@firebase/messaging-compat",N="@firebase/performance",A="@firebase/performance-compat",O="@firebase/remote-config",x="@firebase/remote-config-compat",F="@firebase/storage",B="@firebase/storage-compat",H="@firebase/firestore",M="@firebase/ai",U="@firebase/firestore-compat",T="firebase",R="[DEFAULT]",L={[f]:"fire-core",[m]:"fire-core-compat",[u]:"fire-analytics",[g]:"fire-analytics-compat",[v]:"fire-app-check",[w]:"fire-app-check-compat",[_]:"fire-auth",[C]:"fire-auth-compat",[D]:"fire-rtdb",[y]:"fire-data-connect",[E]:"fire-rtdb-compat",[S]:"fire-fn",[I]:"fire-fn-compat",[$]:"fire-iid",[j]:"fire-iid-compat",[P]:"fire-fcm",[k]:"fire-fcm-compat",[N]:"fire-perf",[A]:"fire-perf-compat",[O]:"fire-rc",[x]:"fire-rc-compat",[F]:"fire-gcs",[B]:"fire-gcs-compat",[H]:"fire-fst",[U]:"fire-fst-compat",[M]:"fire-vertex","fire-js":"fire-js",[T]:"fire-js-all"},V=new Map,z=new Map,J=new Map;function q(e,t){try{e.container.addComponent(t)}catch(a){b.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,a)}}function G(e){const t=e.name;if(J.has(t))return b.debug(`There were multiple attempts to register component ${t}.`),!1;J.set(t,e);for(const a of V.values())q(a,e);for(const a of z.values())q(a,e);return!0}function K(e,t){const a=e.container.getProvider("heartbeat").getImmediate({optional:!0});return a&&a.triggerHeartbeat(),e.container.getProvider(t)}function Q(e){return null!=e&&void 0!==e.settings}
/**
 * @license
 * Copyright 2019 Google LLC
 *
