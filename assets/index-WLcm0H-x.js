import{b6 as Ir,aW as Sr,aX as Tr,r as Yn,b8 as C,bi as Kn,am as Qn,bm as Nr}from"./index-C_tusk_d.js";import{S as kr}from"./Screen-CbGU_0_r.js";import{i as Rr,t as xt,T as Dt,S as Pt,c as Je,d as Ar}from"./MyApp-BHk4QpmU.js";import{A as Xn}from"./index-DnMzjpHt.js";import{C as xr}from"./index-Dd9DM8Te.js";import{L as Ot}from"./index-BoLy8h4N.js";import{P as Dr}from"./progress-DrnHkiEV.js";import"./col-Pgikdtqm.js";import"./row-C5R7REh-.js";import"./responsiveObserver-B2EzRpT-.js";import"./Pagination-DnKRgVhT.js";import"./useBreakpoint-elIeXHeE.js";import"./useForceUpdate-B2hAuu33.js";import"./index-9nvrMV5L.js";import"./List-D28rbV9e.js";import"./PurePanel-DYxAin2C.js";import"./move-DdAuR7Kt.js";import"./DownOutlined-eHux7Fts.js";const Pr=()=>{};var Jn={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ga(n){ot(new Le("platform-logger",e=>new Io(e),"PRIVATE")),ot(new Le("heartbeat",e=>new da(e),"PRIVATE")),fe(Kt,si,n),fe(Kt,si,"esm2017"),fe("fire-js","")}ga("");var ci={};const hi="@firebase/database",ui="1.0.14";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ba{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const i=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let s=0;s<i.length;++s)i[s]&&we(()=>{this.onMessage_(i[s])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bt{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const i=new y(ye,e),s=new y(ye,t);return this.compare(i,s)!==0}minPost(){return y.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ze;class Bs extends bt{static get __EMPTY_NODE(){return Ze}static set __EMPTY_NODE(e){Ze=e}compare(e,t){return be(e.name,t.name)}isDefinedOn(e){throw Ee("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return y.MIN}maxPost(){return new y(oe,Ze)}makePost(e,t){return f(typeof e=="string","KeyIndex indexValue must always be a string."),new y(e,Ze)}toString(){return".key"}}const pe=new Bs;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pl(n,e){return be(n.name,e.name)}function En(n,e){return be(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Vt;const Ne={};class j{static get Default(){return f(N,"ChildrenNode.ts has not been loaded"),Vt=Vt||new j({".priority":Ne},{".priority":N}),Vt}constructor(e,t){this.indexes_=e,this.indexSet_=t}get(e){const t=me(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof L?t:null}hasIndex(e){return Y(this.indexSet_,e.toString())}addIndex(e,t){f(e!==pe,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const i=[];let s=!1;const r=t.getIterator(y.Wrap);let o=r.getNext();for(;o;)s=s||e.isDefinedOn(o.node),i.push(o),o=r.getNext();let a;s?a=ct(i,e.getCompare()):a=Ne;const l=e.toString(),c=Object.assign({},this.indexSet_);c[l]=e;const u=Object.assign({},this.indexes_);return u[l]=a,new j(u,c)}addToIndexes(e,t){const i=it(this.indexes_,(s,r)=>{const o=me(this.indexSet_,r);if(f(o,"Missing index implementation for "+r),s===Ne)if(o.isDefinedOn(e.node)){const a=[],l=t.getIterator(y.Wrap);let c=l.getNext();for(;c;)c.name!==e.name&&a.push(c),c=l.getNext();return a.push(e),ct(a,o.getCompare())}else return Ne;else{const a=t.get(e.name);let l=s;return a&&(l=l.remove(new y(e.name,a))),l.insert(e,e.node)}});return new j(i,this.indexSet_)}removeFromIndexes(e,t){const i=it(this.indexes_,s=>{if(s===Ne)return s;{const r=t.get(e.name);return r?s.remove(new y(e.name,r)):s}});return new j(i,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sl extends bt{compare(e,t){const i=e.node.compareTo(t.node);return i===0?be(e.name,t.name):i}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return y.MIN}maxPost(){return y.MAX}makePost(e,t){const i=D(e);return new y(t,i)}toString(){return".value"}}const Tl=new Sl;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function js(n){return{type:"value",snapshotNode:n}}function ve(n,e){return{type:"child_added",snapshotNode:e,childName:n}}function We(n,e){return{type:"child_removed",snapshotNode:e,childName:n}}function Ue(n,e,t){return{type:"child_changed",snapshotNode:e,childName:n,oldSnap:t}}function Nl(n,e){return{type:"child_moved",snapshotNode:e,childName:n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bn{constructor(e){this.index_=e}updateChild(e,t,i,s,r,o){f(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(t);return a.getChild(s).equals(i.getChild(s))&&a.isEmpty()===i.isEmpty()||(o!=null&&(i.isEmpty()?e.hasChild(t)?o.trackChildChange(We(t,a)):f(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(ve(t,i)):o.trackChildChange(Ue(t,i,a))),e.isLeafNode()&&i.isEmpty())?e:e.updateImmediateChild(t,i).withIndex(this.index_)}updateFullNode(e,t,i){return i!=null&&(e.isLeafNode()||e.forEachChild(N,(s,r)=>{t.hasChild(s)||i.trackChildChange(We(s,r))}),t.isLeafNode()||t.forEachChild(N,(s,r)=>{if(e.hasChild(s)){const o=e.getImmediateChild(s);o.equals(r)||i.trackChildChange(Ue(s,r,o))}else i.trackChildChange(ve(s,r))})),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?g.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var U;(function(n){n[n.OVERWRITE=0]="OVERWRITE",n[n.MERGE=1]="MERGE",n[n.ACK_USER_WRITE=2]="ACK_USER_WRITE",n[n.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(U||(U={}));function Gs(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function In(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function Sn(n){return{fromUser:!1,fromServer:!0,queryId:n,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dt{constructor(e,t,i){this.path=e,this.affectedTree=t,this.revert=i,this.type=U.ACK_USER_WRITE,this.source=Gs()}operationForChild(e){if(v(this.path)){if(this.affectedTree.value!=null)return f(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new w(e));return new dt(E(),t,this.revert)}}else return f(m(this.path)===e,"operationForChild called for unrelated child."),new dt(S(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tn(n,e){return Xs(e,n)}function Hl(n,e,t,i,s){f(i>n.lastWriteId,"Stacking an older write on top of newer ones"),s===void 0&&(s=!0),n.allWrites.push({path:e,snap:t,writeId:i,visible:s}),s&&(n.visibleWrites=Pe(n.visibleWrites,e,t)),n.lastWriteId=i}function Vl(n,e){for(let t=0;t<n.allWrites.length;t++){const i=n.allWrites[t];if(i.writeId===e)return i}return null}function jl(n,e){const t=n.allWrites.findIndex(a=>a.writeId===e);f(t>=0,"removeWrite called with nonexistent writeId.");const i=n.allWrites[t];n.allWrites.splice(t,1);let s=i.visible,r=!1,o=n.allWrites.length-1;for(;s&&o>=0;){const a=n.allWrites[o];a.visible&&(o>=t&&$l(a,i.path)?s=!1:W(i.path,a.path)&&(r=!0)),o--}if(s){if(r)return Gl(n),!0;if(i.snap)n.visibleWrites=Ai(n.visibleWrites,i.path);else{const a=i.children;B(a,l=>{n.visibleWrites=Ai(n.visibleWrites,k(i.path,l))})}return!0}else return!1}function $l(n,e){if(n.snap)return W(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&W(k(n.path,t),e))return!0;return!1}function Gl(n){n.visibleWrites=Ys(n.allWrites,ql,E()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function ql(n){return n.visible}function Ys(n,e,t){let i=H.empty();for(let s=0;s<n.length;++s){const r=n[s];if(e(r)){const o=r.path;let a;if(r.snap)W(t,o)?(a=M(t,o),i=Pe(i,a,r.snap)):W(o,t)&&(a=M(o,t),i=Pe(i,E(),r.snap.getChild(a)));else if(r.children){if(W(t,o))a=M(t,o),i=Ri(i,a,r.children);else if(W(o,t))if(a=M(o,t),v(a))i=Ri(i,E(),r.children);else{const l=me(r.children,m(a));if(l){const c=l.getChild(S(a));i=Pe(i,E(),c)}}}else throw Ee("WriteRecord should have .snap or .children")}}return i}function Ks(n,e,t,i,s){if(!i&&!s){const r=he(n.visibleWrites,e);if(r!=null)return r;{const o=J(n.visibleWrites,e);if(rn(o))return t;if(t==null&&!sn(o,E()))return null;{const a=t||g.EMPTY_NODE;return Ce(o,a)}}}else{const r=J(n.visibleWrites,e);if(!s&&rn(r))return t;if(!s&&t==null&&!sn(r,E()))return null;{const o=function(c){return(c.visible||s)&&(!i||!~i.indexOf(c.writeId))&&(W(c.path,e)||W(e,c.path))},a=Ys(n.allWrites,o,e),l=t||g.EMPTY_NODE;return Ce(a,l)}}}function zl(n,e,t){let i=g.EMPTY_NODE;const s=he(n.visibleWrites,e);if(s)return s.isLeafNode()||s.forEachChild(N,(r,o)=>{i=i.updateImmediateChild(r,o)}),i;if(t){const r=J(n.visibleWrites,e);return t.forEachChild(N,(o,a)=>{const l=Ce(J(r,new w(o)),a);i=i.updateImmediateChild(o,l)}),xi(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}else{const r=J(n.visibleWrites,e);return xi(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}}function Yl(n,e,t,i,s){f(i||s,"Either existingEventSnap or existingServerSnap must exist");const r=k(e,t);if(sn(n.visibleWrites,r))return null;{const o=J(n.visibleWrites,r);return rn(o)?s.getChild(t):Ce(o,s.getChild(t))}}function Kl(n,e,t,i){const s=k(e,t),r=he(n.visibleWrites,s);if(r!=null)return r;if(i.isCompleteForChild(t)){const o=J(n.visibleWrites,s);return Ce(o,i.getNode().getImmediateChild(t))}else return null}function Ql(n,e){return he(n.visibleWrites,e)}function Xl(n,e,t,i,s,r,o){let a;const l=J(n.visibleWrites,e),c=he(l,E());if(c!=null)a=c;else if(t!=null)a=Ce(l,t);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const u=[],h=o.getCompare(),d=r?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let _=d.getNext();for(;_&&u.length<s;)h(_,i)!==0&&u.push(_),_=d.getNext();return u}else return[]}function Jl(){return{visibleWrites:H.empty(),allWrites:[],lastWriteId:-1}}function ft(n,e,t,i){return Ks(n.writeTree,n.treePath,e,t,i)}function Nn(n,e){return zl(n.writeTree,n.treePath,e)}function Di(n,e,t,i){return Yl(n.writeTree,n.treePath,e,t,i)}function _t(n,e){return Ql(n.writeTree,k(n.treePath,e))}function Zl(n,e,t,i,s,r){return Xl(n.writeTree,n.treePath,e,t,i,s,r)}function kn(n,e,t){return Kl(n.writeTree,n.treePath,e,t)}function Qs(n,e){return Xs(k(n.treePath,e),n.writeTree)}function Xs(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yc{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Hn(n,e){let t=null;for(let i=0;i<e.length;i++){const s=e[i],r=s.getPath();t!==null&&!vn(r,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:r}),t.events.push(s)}t&&n.eventLists_.push(t)}function pr(n,e,t){Hn(n,t),gr(n,i=>vn(i,e))}function z(n,e,t){Hn(n,t),gr(n,i=>W(i,e)||W(e,i))}function gr(n,e){n.recursionDepth_++;let t=!0;for(let i=0;i<n.eventLists_.length;i++){const s=n.eventLists_[i];if(s){const r=s.path;e(r)?(Kc(n.eventLists_[i]),n.eventLists_[i]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function Kc(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const i=t.getEventRunner();Ae&&O("event: "+t.toString()),we(i)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nh(n){ma(ra),ot(new Le("database",(e,{instanceIdentifier:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return Eh(i,s,r,t)},"PUBLIC").setMultipleInstances(!0)),fe(hi,ui,n),fe(hi,ui,"esm2017")}$.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};$.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};Nh();var kh="firebase",Rh="11.6.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
