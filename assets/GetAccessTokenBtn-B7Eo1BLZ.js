import{aJ as m,aL as o,aN as p}from"./index-C9a7kOyS.js";import{u,A as y,t as a,f as h}from"./MyApp-eLgOszab.js";import{D as l}from"./index-BYTpD0UZ.js";import"./Dropdown-gfxpn-z7.js";import"./PurePanel-DJB0B014.js";function b(){const{ti:s}=m(),{message:n,notification:r}=u(),k=async e=>{if(e.key==="check-permission"){const i=prompt(s({en:`Enter access token that you want to check in here:
