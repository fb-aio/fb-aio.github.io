import{aK as m,aM as o,aO as p}from"./index-BhpijPa_.js";import{u,A as y,t as a,e as h}from"./MyApp-DC6BurEI.js";import{D as l}from"./index-lgcROXzr.js";import"./Dropdown-D9QVkOaa.js";import"./PurePanel-BDJlIscd.js";function b(){const{ti:s}=m(),{message:n,notification:r}=u(),k=async e=>{if(e.key==="check-permission"){const i=prompt(s({en:`Enter access token that you want to check in here:
