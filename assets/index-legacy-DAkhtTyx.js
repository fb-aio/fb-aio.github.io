System.register(["./index-legacy-30tEudgh.js","./Screen-legacy-ASKoKoLR.js","./MyApp-legacy-CQS-Efd8.js","./index-legacy-DwpF1gpd.js","./index-legacy-0Uv-i9pX.js","./index-legacy-DgoKD78l.js","./progress-legacy-DdNgGVTw.js","./col-legacy-BnRyjH3Q.js","./row-legacy-CP-jeVMx.js","./responsiveObserver-legacy-Deb0QZ7w.js","./Pagination-legacy-BPsVqBcZ.js","./useBreakpoint-legacy-ts76RdoC.js","./useForceUpdate-legacy-CB_aP2VH.js","./index-legacy-Cb8C6c44.js","./List-legacy-une8Ng1W.js","./PurePanel-legacy-Cv3wQfj3.js","./move-legacy-DlwolDKV.js","./DownOutlined-legacy-BLB3MYea.js"],(function(e,t){"use strict";var n,i,s,r,o,a,l,h,c,u,d,p,_,f,g,m,y,v,C;return{setters:[e=>{n=e.b7,i=e.aW,s=e.aX,r=e.r,o=e.b9,a=e.bj,l=e.am,h=e.bn},e=>{c=e.S},e=>{u=e.i,d=e.t,p=e.T,_=e.S,f=e.c,g=e.d},e=>{m=e.A},e=>{y=e.C},e=>{v=e.L},e=>{C=e.P},null,null,null,null,null,null,null,null,null,null,null],execute:function(){e("default",(function(){const{ti:e}=n(),t=i(s.profile),[g,b]=u("ComingSoon.votes",{},!0);r.useEffect((()=>{d("ComingSoon:onLoad")}),[]),r.useEffect((()=>{const e=Ro(jo,"feature_votes"),t=function(e,t,n){const i=new So(n,void 0),s=new Oo(i);return function(e,t,n){let i;i=".info"===Rn(t._path)?cr(e.infoSyncTree_,t,n):cr(e.serverSyncTree_,t,n),Xr(e.eventQueue_,t._path,i)}(e._repo,e,s),()=>function(e,t,n){let i;i=".info"===Rn(t._path)?hr(e.infoSyncTree_,t,n):hr(e.serverSyncTree_,t,n),Xr(e.eventQueue_,t._path,i)}(e._repo,e,s)}(e,0,(e=>{const t=e.val();b(t||{})}));return()=>{t()}}),[]);const w=t=>{switch(t){case Uo.Idea:return o.jsx(f,{color:"success",icon:o.jsx("i",{className:"fa-solid fa-lightbulb"}),children:" "+e({en:"Idea",vi:"Ý tưởng"})});case Uo.Pending:return o.jsx(f,{color:"warning",icon:o.jsx("i",{className:"fa-solid fa-hourglass-half"}),children:" "+e({en:"Pending",vi:"Hàng chờ"})});case Uo.InProgress:return o.jsx(f,{color:"processing",icon:o.jsx("i",{className:"fa-solid fa-forward"}),children:" "+e({en:"In progress",vi:"Đang phát triển"})})}};return o.jsxs(c,{title:e({en:"Coming soon",vi:"Sắp ra mắt"})+" 🌠",mode:"center",children:[o.jsx(m,{type:"info",showIcon:!0,message:o.jsxs(o.Fragment,{children:[e({en:"Priority order: Based on VIP members, the higher the VIP package, the higher the priority",vi:"Thứ tự ưu tiên: Dựa trên thành viên VIP, gói VIP cao hơn sẽ được ưu tiên làm trước"})," 💎 ",o.jsxs(a,{to:"/vip",children:[e({en:"Unlock VIP",vi:"Xem VIP"})," ",o.jsx("i",{className:"fa-solid fa-arrow-right"})]})]}),style:{marginBottom:5}}),o.jsx(m,{showIcon:!0,type:"success",message:e({en:"Click the vote button to let the admin know your request",vi:"Bấm bình chọn để admin thấy cánh tay của bạn"})+" 👆",style:{marginBottom:20}}),o.jsx(y,{style:{maxWidth:800,width:"100%",margin:"0 auto",marginBottom:10},children:o.jsx(v,{dataSource:Ho,renderItem:n=>{return o.jsx(v.Item,{extra:[o.jsx(p,{title:e({en:"Upvote",vi:"Bình chọn"}),children:o.jsx(l,{type:"text",icon:o.jsx("i",{className:"fa-solid fa-thumbs-up"}),onClick:()=>(async e=>{if(!t?.uid)return;const n=Ro(jo,`feature_votes/${e}`),i=g[e]||[];if(i.includes(t.uid)){const s=i.filter((e=>e!==t.uid));await Ao(n,s),d("ComingSoon:unVote:"+e)}else await Ao(n,[...i,t.uid]),d("ComingSoon:vote:"+e)})(n.id),disabled:!t?.uid,style:{color:(i=n.id,t?.uid&&g[i]?.includes(t.uid)?"#1890ff":void 0)},children:g[n.id]?.length||0})},n.id+"upvote")],children:o.jsx(v.Item.Meta,{avatar:o.jsx("i",{className:n.icon+" fa-xl"}),title:o.jsxs(_,{children:[o.jsx(Bo,{strong:!0,children:e(n.name)}),n.link&&o.jsx(p,{title:e({en:"Preview",vi:"Xem trước"}),children:o.jsx(a,{to:n.link,target:n.link?.includes("http")?"_blank":"_self",children:o.jsx("i",{className:"fa-solid fa-arrow-right"})})})]}),description:o.jsxs(_,{direction:"vertical",size:"small",style:{width:"100%"},children:[o.jsx(Bo,{type:"secondary",children:e(n.description).split("\n").map((e=>o.jsx("div",{children:e},e)))}),o.jsxs(_,{wrap:!0,size:0,children:[n.createdAt&&o.jsx(p,{title:e({en:"Created at",vi:"Ngày tạo"})+": "+n.createdAt,children:o.jsxs(f,{color:"default",icon:o.jsx("i",{className:"fa-solid fa-clock"}),children:[" ",h(new Date(n.createdAt).getTime())]})}),w(n.status),n.status===Uo.InProgress&&n.progress>0&&o.jsx(C,{size:"small",style:{width:150},percent:n.progress})]})]})})});var i}})}),o.jsx(l,{icon:o.jsx("i",{className:"fa-solid fa-question"}),href:"https://www.facebook.com/groups/fbaio/posts/1624543838200298",type:"primary",target:"_blank",children:e({en:"Want more",vi:"Yêu cầu thêm"})})]})}));var t={};
/**
             * @license
...
/**
             ...
             * See the License for the specific language governing permissions and
             * limitations under the License.
             */const H=function(e){let t={},n={},i={},s="";try{const r=e.split(".");t=B(P(r[0])||""),n=B(P(r[1])||""),s=r[2],i=n.d||{},delete n.d}catch(r){}return{header:t,claims:n,data:i,signature:s}};
/**
             * @license
             * Copyright 2017 Google LLC
             *
...
/**
             ...
             * limitations under the License.
             */
class Se{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map((e=>{if(function(e){const t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null})).filter((e=>e)).join(" ")}}const Ne="@firebase/app",Pe="0.11.4",xe=new he("@firebase/app"),Re="@firebase/app-compat",De="@firebase/analytics-compat",Ae="@firebase/analytics",Oe="@firebase/app-check-compat",Me="@firebase/app-check",Le="@firebase/auth",Fe="@firebase/auth-compat",qe="@firebase/database",je="@firebase/data-connect",Ue="@firebase/database-compat",Be="@firebase/functions",We="@firebase/functions-compat",He="@firebase/installations",ze="@firebase/installations-compat",Ve="@firebase/messaging",$e="@firebase/messaging-compat",Ye="@firebase/performance",Ke="@firebase/performance-compat",Ge="@firebase/remote-config",Qe="@firebase/remote-config-compat",Je="@firebase/storage",Xe="@firebase/storage-compat",Ze="@firebase/firestore",et="@firebase/vertexai",tt="@firebase/firestore-compat",nt="firebase",it="[DEFAULT]",st={[Ne]:"fire-core",[Re]:"fire-core-compat",[Ae]:"fire-analytics",[De]:"fire-analytics-compat",[Me]:"fire-app-check",[Oe]:"fire-app-check-compat",[Le]:"fire-auth",[Fe]:"fire-auth-compat",[qe]:"fire-rtdb",[je]:"fire-data-connect",[Ue]:"fire-rtdb-compat",[Be]:"fire-fn",[We]:"fire-fn-compat",[He]:"fire-iid",[ze]:"fire-iid-compat",[Ve]:"fire-fcm",[$e]:"fire-fcm-compat",[Ye]:"fire-perf",[Ke]:"fire-perf-compat",[Ge]:"fire-rc",[Qe]:"fire-rc-compat",[Je]:"fire-gcs",[Xe]:"fire-gcs-compat",[Ze]:"fire-fst",[tt]:"fire-fst-compat",[et]:"fire-vertex","fire-js":"fire-js",[nt]:"fire-js-all"},rt=new Map,ot=new Map,at=new Map;function lt(e,t){try{e.container.addComponent(t)}catch(n){xe.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function ht(e){const t=e.name;if(at.has(t))return xe.debug(`There were multiple attempts to register component ${t}.`),!1;at.set(t,e);for(const n of rt.values())lt(n,e);for(const n of ot.values())lt(n,e);return!0}
/**
             * @license
             * Copyright 2019 Google LLC
             *
...
/**
             ...
             * See the License for the specific language governing permissions and
             * limitations under the License.
             */(e,((e,i)=>{ji(i,new Pn(t.toString()+"/"+e),n)}))}class Ui{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&Xt(this.last_,((e,n)=>{t[e]=t[e]-n})),this.last_=e,t}}
/**
             * @license
             * Copyright 2017 Google LLC
             *
             ...
             * See the License for the specific language governing permissions and
             * limitations under the License.
             */class Bi{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Ui(e);const n=1e4+2e4*Math.random();sn(this.reportStats_.bind(this),Math.floor(n))}reportStats_(){const e=this.statsListener_.get(),t={};let n=!1;Xt(e,((e,i)=>{i>0&&z(this.statsToReport_,e)&&(t[e]=i,n=!0)})),n&&this.server_.reportStats(t),sn(this.reportStats_.bind(this),Math.floor(2*Math.random()*3e5))}}
/**
             * @license
             * Copyright 2017 Google LLC
             *
...
/**
             ...
             * limitations under the License.
             */
class Qr{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Jr(e,t){let n=null;for(let i=0;i<t.length;i++){const s=t[i],r=s.getPath();null===n||Un(r,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:r}),n.events.push(s)}n&&e.eventLists_.push(n)}function Xr(e,t,n){Jr(e,n),eo(e,(e=>Un(e,t)))}function Zr(e,t,n){Jr(e,n),eo(e,(e=>Bn(e,t)||Bn(t,e)))}function eo(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const s=e.eventLists_[i];s&&(t(s.path)?(to(e.eventLists_[i]),e.eventLists_[i]=null):n=!1)}n&&(e.eventLists_=[]),e.recursionDepth_--}function to(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();Ft&&jt("event: "+n.toString()),nn(i)}}}
/**
             * @license
             * Copyright 2017 Google LLC
             *
