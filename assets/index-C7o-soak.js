const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./IconSelector-DA7EhM4x.js","./index-Ced3wruU.js","./index-DCer0mQl.css","./MyApp-mQ2e6ewg.js","./index-BAX4ZDc1.js","./PurePanel-DNW3vKM3.js","./index-C1Tvilu7.js","./Input-DWJOgVSi.js","./EyeOutlined-DBtc_uEw.js","./SearchOutlined-CRdAnj1X.js"])))=>i.map(i=>d[i]);
import{aS as e,aQ as t,r as n,aP as i,b1 as s,b9 as r,b5 as o,b2 as a,aN as l}from"./index-Ced3wruU.js";import{S as c}from"./Screen-yuRpAOaA.js";import{u as h,d as u,t as d,s as p,S as f,b as _,A as m,c as g,e as y,T as v,f as C,ah as b,aH as w,I}from"./MyApp-mQ2e6ewg.js";import T from"./useCacheState-C_Go9Tvn.js";import{B as E}from"./BadgeWrapper-Cq-hcnyG.js";import{M as x}from"./index-BAX4ZDc1.js";import{I as S}from"./index-C1Tvilu7.js";import{S as k}from"./index-7WHZHHgi.js";import{E as N}from"./index-BCX34fqy.js";import{C as P}from"./index-CeOvEP1e.js";import{P as R}from"./index-6QrNOmay.js";import{T as D}from"./index-bm3uRXA1.js";import"./col-JSrukBPB.js";import"./row-B0VbVlUt.js";import"./useBreakpoint-SZrlJrbq.js";import"./PurePanel-DNW3vKM3.js";import"./Input-DWJOgVSi.js";import"./EyeOutlined-DBtc_uEw.js";import"./SearchOutlined-CRdAnj1X.js";import"./move-CPe_ufVX.js";import"./DownOutlined-IY6d3YuG.js";import"./index-J2TEgfCF.js";import"./Dropdown-CO57vN60.js";
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xi extends Hn{reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return void 0!==t?"tag$"+t:(O(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}constructor(e,t,n,i){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=n,this.appCheckTokenProvider_=i,this.log_=sn("p:rest:"),this.listens_={}}listen(e,t,n,i){const s=e._path.toString();this.log_("Listen called for "+s+" "+e._queryIdentifier);const r=Xi.getListenId_(e,n),o={};this.listens_[r]=o;const a=Gi(e._queryParams);this.restRequest_(s+".json",a,((e,t)=>{let a=t;if(404===e&&(a=null,e=null),null===e&&this.onDataUpdate_(s,a,!1,n),le(this.listens_,r)===o){let t;t=e?401===e?"permission_denied":"rest_error:"+e:"ok",i(t,null)}}))}unlisten(e,t){const n=Xi.getListenId_(e,t);delete this.listens_[n]}get(e){const t=Gi(e._queryParams),n=e._path.toString(),i=new G;return this.restRequest_(n+".json",t,((e,t)=>{let s=t;404===e&&(s=null,e=null),null===e?(this.onDataUpdate_(n,s,!1,null),i.resolve(s)):i.reject(new Error(s))})),i.promise}refreshAuthToken(e){}restRequest_(e,t={},n){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then((([i,s])=>{i&&i.accessToken&&(t.auth=i.accessToken),s&&s.token&&(t.ac=s.token);const r=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+function(e){const t=[];for(const[n,i]of Object.entries(e))Array.isArray(i)?i.forEach((e=>{t.push(encodeURIComponent(n)+"="+encodeURIComponent(e))})):t.push(encodeURIComponent(n)+"="+encodeURIComponent(i));return t.length?"&"+t.join("&"):""}(t);this.log_("Sending REST request for "+r);const o=new XMLHttpRequest;o.onreadystatechange=()=>{if(n&&4===o.readyState){this.log_("REST Response for "+r+" received. status:",o.status,"response:",o.responseText);let t=null;if(o.status>=200&&o.status<300){try{t=se(o.responseText)}catch(e){an("Failed to parse JSON response for "+r+": "+o.responseText)}n(null,t)}else 401!==o.status&&404!==o.status&&an("Got unsuccessful REST response for "+r+" Status: "+o.status),n(o.status);n=null}},o.open("GET",r,!0),o.send()}))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ji{constructor(){this.rootNode_=Li.EMPTY_NODE}getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gs(e,t,n,i,s){const r=new $s;let o,a;if(n.type===ss.OVERWRITE){const l=n;l.source.fromUser?o=Js(e,t,l.path,l.snap,i,s,r):(O(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered()&&!ti(l.path),o=Xs(e,t,l.path,l.snap,i,s,a,r))}else if(n.type===ss.MERGE){const l=n;l.source.fromUser?o=function(e,t,n,i,s,r,o){let a=t;return i.foreach(((i,l)=>{const c=ei(n,i);Zs(t,Kn(c))&&(a=Js(e,a,c,l,s,r,o))})),i.foreach(((i,l)=>{const c=ei(n,i);Zs(t,Kn(c))||(a=Js(e,a,c,l,s,r,o))})),a}(e,t,l.path,l.children,i,s,r):(O(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered(),o=tr(e,t,l.path,l.children,i,s,a,r))}else if(n.type===ss.ACK_USER_WRITE){const a=n;o=a.revert?function(e,t,n,i,s,r){let o;if(null!=Ws(i,n))return t;{const a=new Ks(i,t,s),l=t.eventCache.getNode();let c;if(ti(n)||".priority"===Kn(n)){let n;if(t.serverCache.isFullyInitialized())n=Fs(i,ys(t));else{const e=t.serverCache.getNode();O(e instanceof Li,"serverChildren would be complete if leaf node"),n=qs(i,e)}c=e.filter.updateFullNode(l,n,r)}else{const s=Kn(n);let h=Hs(i,s,t.serverCache);null==h&&t.serverCache.isCompleteForChild(s)&&(h=l.getImmediateChild(s)),c=null!=h?e.filter.updateChild(l,s,h,Qn(n),a,r):t.eventCache.getNode().hasChild(s)?e.filter.updateChild(l,s,Li.EMPTY_NODE,Qn(n),a,r):l,c.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=Fs(i,ys(t)),o.isLeafNode()&&(c=e.filter.updateFullNode(c,o,r)))}return o=t.serverCache.isFullyInitialized()||null!=Ws(i,Yn()),_s(t,c,o,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){zt="11.9.0",xt(new ge("database",((e,{instanceIdentifier:t})=>Xo(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),Pt(Ut,Ht,e),Pt(Ut,Ht,"esm2017")}();
/**
 * @license
 * Copyright 2020 Google LLC
 *
