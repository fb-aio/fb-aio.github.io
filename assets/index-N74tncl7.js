import{aV as e,aT as t,r as n,b3 as i,bc as s,b7 as r}from"./index-DZf__y3d.js";import{S as o}from"./Screen-BYXLGFC5.js";import{u as a,t as c,A as l,S as h,c as u,T as d,b as p,e as _}from"./MyApp-B1VxwvDo.js";import f from"./useCacheState-PjqIJ5uj.js";import{C as m}from"./index-BH3ZF-PC.js";import{L as g}from"./index-CJZyKGwy.js";import{P as y}from"./progress-DHoIpVFZ.js";import"./col-DqpYzSW3.js";import"./row-Kbi9VpYo.js";import"./useBreakpoint-Ctqd1rJL.js";import"./index-CK0b7god.js";import"./Dropdown-CNPrSGMW.js";import"./index-BjwN9AKq.js";import"./List-BmZL4d0d.js";import"./PurePanel-BjPsgyLn.js";import"./index-BIV2alZK.js";import"./move-CTvyxEsh.js";import"./DownOutlined-B3W6anfM.js";import"./SearchOutlined-BGihTfp6.js";import"./Pagination-DE0E0Ir0.js";var v={};
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Y=function(e){let t={},n={},i={},s="";try{const r=e.split(".");t=V(N(r[0])||""),n=V(N(r[1])||""),s=r[2],i=n.d||{},delete n.d}catch(r){}return{header:t,claims:n,data:i,signature:s}};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class xe{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map((e=>{if(function(e){const t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){const t=e.getImmediate();return"".concat(t.library,"/").concat(t.version)}return null})).filter((e=>e)).join(" ")}}const Re="@firebase/app",De="0.13.1",Ae=new pe("@firebase/app"),Oe="@firebase/app-compat",Me="@firebase/analytics-compat",Le="@firebase/analytics",Fe="@firebase/app-check-compat",qe="@firebase/app-check",je="@firebase/auth",Be="@firebase/auth-compat",Ue="@firebase/database",We="@firebase/data-connect",He="@firebase/database-compat",Ve="@firebase/functions",ze="@firebase/functions-compat",Ye="@firebase/installations",Ke="@firebase/installations-compat",Ge="@firebase/messaging",Qe="@firebase/messaging-compat",$e="@firebase/performance",Je="@firebase/performance-compat",Xe="@firebase/remote-config",Ze="@firebase/remote-config-compat",et="@firebase/storage",tt="@firebase/storage-compat",nt="@firebase/firestore",it="@firebase/ai",st="@firebase/firestore-compat",rt="firebase",ot="[DEFAULT]",at={[Re]:"fire-core",[Oe]:"fire-core-compat",[Le]:"fire-analytics",[Me]:"fire-analytics-compat",[qe]:"fire-app-check",[Fe]:"fire-app-check-compat",[je]:"fire-auth",[Be]:"fire-auth-compat",[Ue]:"fire-rtdb",[We]:"fire-data-connect",[He]:"fire-rtdb-compat",[Ve]:"fire-fn",[ze]:"fire-fn-compat",[Ye]:"fire-iid",[Ke]:"fire-iid-compat",[Ge]:"fire-fcm",[Qe]:"fire-fcm-compat",[$e]:"fire-perf",[Je]:"fire-perf-compat",[Xe]:"fire-rc",[Ze]:"fire-rc-compat",[et]:"fire-gcs",[tt]:"fire-gcs-compat",[nt]:"fire-fst",[st]:"fire-fst-compat",[it]:"fire-vertex","fire-js":"fire-js",[rt]:"fire-js-all"},ct=new Map,lt=new Map,ht=new Map;function ut(e,t){try{e.container.addComponent(t)}catch(n){Ae.debug("Component ".concat(t.name," failed to register with FirebaseApp ").concat(e.name),n)}}function dt(e){const t=e.name;if(ht.has(t))return Ae.debug("There were multiple attempts to register component ".concat(t,".")),!1;ht.set(t,e);for(const n of ct.values())ut(n,e);for(const n of lt.values())ut(n,e);return!0}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Vi,zi;function Yi(e){return{fromUser:!1,fromServer:!0,queryId:e,tagged:!0}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gi{constructor(e,t){this.source=e,this.path=t,this.type=Vi.LISTEN_COMPLETE}operationForChild(e){return Un(this.path)?new Gi(this.source,An()):new Gi(this.source,Ln(this.path))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qi{constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=Vi.OVERWRITE}operationForChild(e){return Un(this.path)?new Qi(this.source,An(),this.snap.getImmediateChild(e)):new Qi(this.source,Ln(this.path),this.snap)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $i{constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Vi.MERGE}operationForChild(e){if(Un(this.path)){const t=this.children.subtree(new Dn(e));return t.isEmpty()?null:t.value?new Qi(this.source,An(),t.value):new $i(this.source,An(),t)}return b(On(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new $i(this.source,Ln(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ms(e,t,n,i,s){const r=new Ds;let o,a;if(n.type===Vi.OVERWRITE){const c=n;c.source.fromUser?o=qs(e,t,c.path,c.snap,i,s,r):(b(c.source.fromServer,"Unknown source."),a=c.source.tagged||t.serverCache.isFiltered()&&!Un(c.path),o=Fs(e,t,c.path,c.snap,i,s,a,r))}else if(n.type===Vi.MERGE){const c=n;c.source.fromUser?o=function(e,t,n,i,s,r,o){let a=t;return i.foreach(((i,c)=>{const l=Bn(n,i);js(t,On(l))&&(a=qs(e,a,l,c,s,r,o))})),i.foreach(((i,c)=>{const l=Bn(n,i);js(t,On(l))||(a=qs(e,a,l,c,s,r,o))})),a}(e,t,c.path,c.children,i,s,r):(b(c.source.fromServer,"Unknown source."),a=c.source.tagged||t.serverCache.isFiltered(),o=Us(e,t,c.path,c.children,i,s,a,r))}else if(n.type===Vi.ACK_USER_WRITE){const a=n;o=a.revert?function(e,t,n,i,s,r){let o;if(null!=Ss(i,n))return t;{const a=new Os(i,t,s),c=t.eventCache.getNode();let l;if(Un(n)||".priority"===On(n)){let n;if(t.serverCache.isFullyInitialized())n=ks(i,ss(t));else{const e=t.serverCache.getNode();b(e instanceof wi,"serverChildren would be complete if leaf node"),n=Ts(i,e)}l=e.filter.updateFullNode(c,n,r)}else{const s=On(n);let h=Ps(i,s,t.serverCache);null==h&&t.serverCache.isCompleteForChild(s)&&(h=c.getImmediateChild(s)),l=null!=h?e.filter.updateChild(c,s,h,Ln(n),a,r):t.eventCache.getNode().hasChild(s)?e.filter.updateChild(c,s,wi.EMPTY_NODE,Ln(n),a,r):c,l.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=ks(i,ss(t)),o.isLeafNode()&&(l=e.filter.updateFullNode(l,o,r)))}return o=t.serverCache.isFullyInitialized()||null!=Ss(i,An()),ts(t,l,o,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Gr{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Qr(e,t){let n=null;for(let i=0;i<t.length;i++){const s=t[i],r=s.getPath();null===n||Hn(r,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:r}),n.events.push(s)}n&&e.eventLists_.push(n)}function $r(e,t,n){Qr(e,n),Xr(e,(e=>Hn(e,t)))}function Jr(e,t,n){Qr(e,n),Xr(e,(e=>Vn(e,t)||Vn(t,e)))}function Xr(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const s=e.eventLists_[i];if(s){t(s.path)?(Zr(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function Zr(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();Bt&&Wt("event: "+n.toString()),on(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const Ao={};let Oo=!1;function Mo(e,t,n,i,s){let r=i||e.options.databaseURL;void 0===r&&(e.options.projectId||zt("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Wt("Using default host for project ",e.options.projectId),r="".concat(e.options.projectId,"-default-rtdb.firebaseio.com"));let o,a=Co(r,s),c=a.repoInfo;"undefined"!=typeof process&&St&&(o=St.FIREBASE_DATABASE_EMULATOR_HOST),o?(r="http://".concat(o,"?ns=").concat(c.namespace),a=Co(r,s),c=a.repoInfo):a.repoInfo.secure;const l=new ln(e.name,e.options,t);Kr("Invalid Firebase Database URL",a),Un(a.path)||zt("Database URL must point to the root of a Firebase Database (not including a child path).");const h=function(e,t,n,i){let s=Ao[t.name];s||(s={},Ao[t.name]=s);let r=s[e.toURLString()];r&&zt("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return r=new eo(e,Oo,n,i),s[e.toURLString()]=r,r}(c,e,l,new cn(e,n));return new Lo(h,e)}class Lo{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(to(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Eo(this._repo,An())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=Ao[t];n&&n[e.key]===e||zt("Database ".concat(t,"(").concat(e.repoInfo_,") has already been deleted.")),function(e){e.persistentConnection_&&e.persistentConnection_.interrupt("repo_interrupt")}(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&zt("Cannot call "+e+" on a deleted database.")}}$n.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},$n.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)},
/**
 * @license
 * Copyright 2021 Google LLC
 *
