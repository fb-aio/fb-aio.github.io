System.register(["./index-legacy-CEOD2t84.js","./Screen-legacy-e0ESezIx.js","./MyApp-legacy-CFBygotN.js","./index-legacy-BxuZ07Yd.js","./index-legacy-DAZYzIUt.js","./index-legacy-Jx11HALR.js","./progress-legacy-DNEmi9EM.js","./col-legacy-CNQqZJk4.js","./row-legacy-DBnoe-w4.js","./useBreakpoint-legacy-CZgE0Lzv.js","./index-legacy-CaAFCHkI.js","./List-legacy-DhvUnbz7.js","./PurePanel-legacy-CHL32PVE.js","./move-legacy-Csz7v8Yz.js","./DownOutlined-legacy-CVRfeJVe.js","./Pagination-legacy-Yu3Yyt6K.js"],(function(e,t){"use strict";var n,i,s,r,o,a,l,c,h,u,d,p,_,f,g,m,y,v,C;return{setters:[e=>{n=e.b9,i=e.aW,s=e.aX,r=e.r,o=e.bb,a=e.bo,l=e.bi,c=e.aA},e=>{h=e.S},e=>{u=e.h,d=e.t,p=e.S,_=e.c,f=e.T,g=e.b},e=>{m=e.A},e=>{y=e.C},e=>{v=e.L},e=>{C=e.P},null,null,null,null,null,null,null,null,null],execute:function(){e("default",(function(){const{ti:e}=n(),t=i(s.profile),[_,b]=u("ComingSoon.votes",{},!0);r.useEffect((()=>{d("ComingSoon:onLoad")}),[]),r.useEffect((()=>{const e=Mo(Ho,"feature_votes"),t=function(e,t,n){const i=new Ro(n,void 0),s=new qo(i);return function(e,t,n){let i;i=".info"===Mn(t._path)?_r(e.infoSyncTree_,t,n):_r(e.serverSyncTree_,t,n),no(e.eventQueue_,t._path,i)}(e._repo,e,s),()=>function(e,t,n){let i;i=".info"===Mn(t._path)?pr(e.infoSyncTree_,t,n):pr(e.serverSyncTree_,t,n),no(e.eventQueue_,t._path,i)}(e._repo,e,s)}(e,0,(e=>{const t=e.val();b(t||{})}));return()=>{t()}}),[]);const w=t=>{switch(t){case Vo.Idea:return o.jsx(g,{color:"success",icon:o.jsx("i",{className:"fa-solid fa-lightbulb"}),children:" "+e({en:"Idea",vi:"Ý tưởng"})});case Vo.Pending:return o.jsx(g,{color:"warning",icon:o.jsx("i",{className:"fa-solid fa-hourglass-half"}),children:" "+e({en:"Pending",vi:"Hàng chờ"})});case Vo.InProgress:return o.jsx(g,{color:"processing",icon:o.jsx("i",{className:"fa-solid fa-forward"}),children:" "+e({en:"In progress",vi:"Đang phát triển"})})}};return o.jsxs(h,{title:e({en:"Coming soon",vi:"Sắp ra mắt"})+" 🌠",mode:"center",children:[o.jsx(m,{type:"info",showIcon:!0,message:o.jsxs(o.Fragment,{children:[e({en:"Priority order: Based on VIP members, the higher the VIP package, the higher the priority",vi:"Thứ tự ưu tiên: Dựa trên thành viên VIP, gói VIP cao hơn sẽ được ưu tiên làm trước"})," 💎 ",o.jsxs(a,{to:"/vip",children:[e({en:"Unlock VIP",vi:"Xem VIP"})," ",o.jsx("i",{className:"fa-solid fa-arrow-right"})]})]}),style:{marginBottom:5}}),o.jsx(m,{showIcon:!0,type:"success",message:e({en:"Click the vote button to let the admin know your request",vi:"Bấm bình chọn để admin thấy cánh tay của bạn"})+" 👆",style:{marginBottom:20}}),o.jsx(y,{style:{maxWidth:800,width:"100%",margin:"0 auto",marginBottom:10},children:o.jsx(v,{dataSource:Yo,renderItem:n=>{return o.jsx(v.Item,{extra:[o.jsx(f,{title:e({en:"Upvote",vi:"Bình chọn"}),children:o.jsx(c,{type:"text",icon:o.jsx("i",{className:"fa-solid fa-thumbs-up"}),onClick:()=>(async e=>{if(!t?.uid)return;const n=Mo(Ho,`feature_votes/${e}`),i=_[e]||[];if(i.includes(t.uid)){const s=i.filter((e=>e!==t.uid));await Fo(n,s),d("ComingSoon:unVote:"+e)}else await Fo(n,[...i,t.uid]),d("ComingSoon:vote:"+e)})(n.id),disabled:!t?.uid,style:{color:(i=n.id,t?.uid&&_[i]?.includes(t.uid)?"#1890ff":void 0)},children:_[n.id]?.length||0})},n.id+"upvote")],children:o.jsx(v.Item.Meta,{avatar:o.jsx("i",{className:n.icon+" fa-xl"}),title:o.jsxs(p,{children:[o.jsx(zo,{strong:!0,children:e(n.name)}),n.link&&o.jsx(f,{title:e({en:"Preview",vi:"Xem trước"}),children:o.jsx(a,{to:n.link,target:n.link?.includes("http")?"_blank":"_self",children:o.jsx("i",{className:"fa-solid fa-arrow-right"})})})]}),description:o.jsxs(p,{direction:"vertical",size:"small",style:{width:"100%"},children:[o.jsx(zo,{type:"secondary",children:e(n.description).split("\n").map((e=>o.jsx("div",{children:e},e)))}),o.jsxs(p,{wrap:!0,size:0,children:[n.createdAt&&o.jsx(f,{title:e({en:"Created at",vi:"Ngày tạo"})+": "+n.createdAt,children:o.jsxs(g,{color:"default",icon:o.jsx("i",{className:"fa-solid fa-clock"}),children:[" ",l(new Date(n.createdAt).getTime())]})}),w(n.status),n.status===Vo.InProgress&&n.progress>0&&o.jsx(C,{size:"small",style:{width:150},percent:n.progress})]})]})})});var i}})}),o.jsx(c,{icon:o.jsx("i",{className:"fa-solid fa-question"}),href:"https://www.facebook.com/groups/fbaio/posts/1624543838200298",type:"primary",target:"_blank",children:e({en:"Want more",vi:"Yêu cầu thêm"})})]})}));var t={};
/**
             * @license
