System.register(["./index-legacy-VZYWfkWO.js","./Screen-legacy-JEIhoyXE.js","./MyApp-legacy-BQsw4SsG.js","./index-legacy-CD62CQxx.js","./index-legacy-BvKTImJC.js","./index-legacy-4rMA_FKp.js","./progress-legacy-CKl0PYt8.js","./col-legacy-BqwOakz9.js","./row-legacy-DFReeieM.js","./responsiveObserver-legacy-BXbBMgPm.js","./Pagination-legacy-B9eEAVFe.js","./useBreakpoint-legacy-BJdklCkC.js","./useForceUpdate-legacy-BISN8fs9.js","./index-legacy-ME8-GM87.js","./List-legacy-w380Pvza.js","./PurePanel-legacy-CynWmHY_.js","./move-legacy-DzC36xei.js","./DownOutlined-legacy-CLx7Ocj0.js"],(function(e,t){"use strict";var n,i,s,r,o,a,l,h,c,u,d,p,_,f,g,m,y,v,C;return{setters:[e=>{n=e.b7,i=e.aW,s=e.aX,r=e.r,o=e.b9,a=e.bj,l=e.am,h=e.bn},e=>{c=e.S},e=>{u=e.i,d=e.t,p=e.T,_=e.S,f=e.c,g=e.d},e=>{m=e.A},e=>{y=e.C},e=>{v=e.L},e=>{C=e.P},null,null,null,null,null,null,null,null,null,null,null],execute:function(){e("default",(function(){const{ti:e}=n(),t=i(s.profile),[g,b]=u("ComingSoon.votes",{},!0);r.useEffect((()=>{d("ComingSoon:onLoad")}),[]),r.useEffect((()=>{const e=Ro(jo,"feature_votes"),t=function(e,t,n){const i=new So(n,void 0),s=new Oo(i);return function(e,t,n){let i;i=".info"===Rn(t._path)?cr(e.infoSyncTree_,t,n):cr(e.serverSyncTree_,t,n),Xr(e.eventQueue_,t._path,i)}(e._repo,e,s),()=>function(e,t,n){let i;i=".info"===Rn(t._path)?hr(e.infoSyncTree_,t,n):hr(e.serverSyncTree_,t,n),Xr(e.eventQueue_,t._path,i)}(e._repo,e,s)}(e,0,(e=>{const t=e.val();b(t||{})}));return()=>{t()}}),[]);const w=t=>{switch(t){case Bo.Idea:return o.jsx(f,{color:"success",icon:o.jsx("i",{className:"fa-solid fa-lightbulb"}),children:" "+e({en:"Idea",vi:"Ý tưởng"})});case Bo.Pending:return o.jsx(f,{color:"warning",icon:o.jsx("i",{className:"fa-solid fa-hourglass-half"}),children:" "+e({en:"Pending",vi:"Hàng chờ"})});case Bo.InProgress:return o.jsx(f,{color:"processing",icon:o.jsx("i",{className:"fa-solid fa-forward"}),children:" "+e({en:"In progress",vi:"Đang phát triển"})})}};return o.jsxs(c,{title:e({en:"Coming soon",vi:"Sắp ra mắt"})+" 🌠",mode:"center",children:[o.jsx(m,{type:"info",showIcon:!0,message:o.jsxs(o.Fragment,{children:[e({en:"Priority order: Based on VIP members, the higher the VIP package, the higher the priority",vi:"Thứ tự ưu tiên: Dựa trên thành viên VIP, gói VIP cao hơn sẽ được ưu tiên làm trước"})," 💎 ",o.jsxs(a,{to:"/vip",children:[e({en:"Unlock VIP",vi:"Xem VIP"})," ",o.jsx("i",{className:"fa-solid fa-arrow-right"})]})]}),style:{marginBottom:5}}),o.jsx(m,{showIcon:!0,type:"success",message:e({en:"Click the vote button to let the admin know your request",vi:"Bấm bình chọn để admin thấy cánh tay của bạn"})+" 👆",style:{marginBottom:20}}),o.jsx(y,{style:{maxWidth:800,width:"100%",margin:"0 auto",marginBottom:10},children:o.jsx(v,{dataSource:Ho,renderItem:n=>{return o.jsx(v.Item,{extra:[o.jsx(p,{title:e({en:"Upvote",vi:"Bình chọn"}),children:o.jsx(l,{type:"text",icon:o.jsx("i",{className:"fa-solid fa-thumbs-up"}),onClick:()=>(async e=>{if(!t?.uid)return;const n=Ro(jo,`feature_votes/${e}`),i=g[e]||[];if(i.includes(t.uid)){const s=i.filter((e=>e!==t.uid));await Ao(n,s),d("ComingSoon:unVote:"+e)}else await Ao(n,[...i,t.uid]),d("ComingSoon:vote:"+e)})(n.id),disabled:!t?.uid,style:{color:(i=n.id,t?.uid&&g[i]?.includes(t.uid)?"#1890ff":void 0)},children:g[n.id]?.length||0})},n.id+"upvote")],children:o.jsx(v.Item.Meta,{avatar:o.jsx("i",{className:n.icon+" fa-xl"}),title:o.jsxs(_,{children:[o.jsx(Uo,{strong:!0,children:e(n.name)}),n.link&&o.jsx(p,{title:e({en:"Preview",vi:"Xem trước"}),children:o.jsx(a,{to:n.link,target:n.link?.includes("http")?"_blank":"_self",children:o.jsx("i",{className:"fa-solid fa-arrow-right"})})})]}),description:o.jsxs(_,{direction:"vertical",size:"small",style:{width:"100%"},children:[o.jsx(Uo,{type:"secondary",children:e(n.description).split("\n").map((e=>o.jsx("div",{children:e},e)))}),o.jsxs(_,{wrap:!0,size:0,children:[n.createdAt&&o.jsx(p,{title:e({en:"Created at",vi:"Ngày tạo"})+": "+n.createdAt,children:o.jsxs(f,{color:"default",icon:o.jsx("i",{className:"fa-solid fa-clock"}),children:[" ",h(new Date(n.createdAt).getTime())]})}),w(n.status),n.status===Bo.InProgress&&n.progress>0&&o.jsx(C,{size:"small",style:{width:150},percent:n.progress})]})]})})});var i}})}),o.jsx(l,{icon:o.jsx("i",{className:"fa-solid fa-question"}),href:"https://www.facebook.com/groups/fbaio/posts/1624543838200298",type:"primary",target:"_blank",children:e({en:"Want more",vi:"Yêu cầu thêm"})})]})}));var t={};
/**
             * @license
