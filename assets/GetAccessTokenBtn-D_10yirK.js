import{aK as m,aM as o,aO as p}from"./index-C-w4CClV.js";import{u,A as y,t as a,e as h}from"./MyApp-CiieEOcW.js";import{D as l}from"./index-BCVBz-Uj.js";import"./Dropdown-WvCJIWzP.js";import"./PurePanel-BZj1tBmF.js";function b(){const{ti:s}=m(),{message:n,notification:r}=u(),k=async e=>{if(e.key==="check-permission"){const i=prompt(s({en:`Enter access token that you want to check in here:
